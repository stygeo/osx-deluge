...
class AppDelegate
  ...
  #
  # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "osx_deluge" in the user's Library directory.
  #
  def applicationFilesDirectory
      ...
      library_url.URLByAppendingPathComponent("osx_deluge")
  end
  ...
  def managedObjectModel
      unless @managedObjectModel
        model_url = NSBundle.mainBundle.URLForResource("osx_deluge", withExtension:"momd")
  ...
  def persistentStoreCoordinator
      ...
      url = directory.URLByAppendingPathComponent("osx_deluge.storedata")
